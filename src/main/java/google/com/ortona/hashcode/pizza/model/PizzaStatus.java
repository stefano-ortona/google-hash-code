...
public class PizzaStatus {
	...
	/*
	 * for a coordinate i,j, pizzaStatus[i][j]= true if a slice currently covers
	 * that cell
	 */
	boolean[][] pizzaStatus;
	...
	/*
	 * Return true if no cells horizontally between x1 and x2 are currently
	 * occupied, x1 and x2 included
	 */
	...
	/*
	 * Return true if no cells vertically between y1 and y2 are currently occupied,
	 * y1 and y2 included
	 */
